...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      {...props}
    >
      {/* Case TOUJOURS visible : carré bordé à vide, rempli (primary + coche) une fois coché — la
          coche-seule par défaut est invisible tant que non cochée (peu lisible en multi-sélection). */}
      <span className="border-input group-data-[state=checked]:bg-primary group-data-[state=checked]:border-primary group-data-[state=checked]:text-primary-foreground bg-background pointer-events-none absolute left-2 flex size-4 items-center justify-center rounded-[4px] border transition-colors">
