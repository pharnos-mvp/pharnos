...
describe('AdminConsole', () => {
  it('rend le cockpit : h1, 7 pilules, KPIs, statut santé, répartition IA, top consommateurs, audit', async () => {
    ...
    // Sous-navigation en pilules : 7 sections (dont Référentiel, P4.4), l'active porte aria-current.
