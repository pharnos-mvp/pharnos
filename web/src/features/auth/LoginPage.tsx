...
/** Logo « G » officiel Google (4 couleurs), pour le bouton de connexion fédérée. */
function GoogleIcon() {
  return (
    <svg viewBox="0 0 48 48" className="size-4" aria-hidden="true" focusable="false">
      <path
        fill="#EA4335"
...
export function LoginPage() {
  ...
  // Connexion fédérée Google : redirige vers Google en cas de succès (la page navigue,
  // d'où l'absence de remise à zéro de `submitting` sur le chemin nominal).
  ...
  return (
    <div className="bg-background relative flex min-h-svh items-center justify-center p-4">
      ...
      <Card className="w-full max-w-sm">
        <CardHeader>
          <img src="/brand/pharnos-logo.svg" alt="Pharnos" className="mb-2 size-10 dark:hidden" />
          <img
            src="/brand/pharnos-logo-dark.svg"
            alt=""
            aria-hidden="true"
            className="mb-2 hidden size-10 dark:block"
          />
        ...
        <Form {...form}>
          <form onSubmit={mode === 'reset-request' ? onResetRequest : form.handleSubmit(onSubmit)}>
            <CardContent className="space-y-4">
              {mode !== 'reset-request' && env.googleAuthEnabled && (
